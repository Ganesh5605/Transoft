...
class _PaymentvoucherState extends State<Paymentvoucher> {
  ...
  TextEditingController Pnoctrl = TextEditingController();
  TextEditingController Pnamectrl = TextEditingController();
  TextEditingController Pledgerbalancectrl = TextEditingController();
  TextEditingController Pamountctrl = TextEditingController();
  TextEditingController Premarkctrl = TextEditingController();

  FocusNode PNO = FocusNode();
  FocusNode PName = FocusNode();
  FocusNode Plerdgerbalance = FocusNode();
  FocusNode Pamount = FocusNode();
  FocusNode Premark = FocusNode();
            ...
            children: [
                    ...
                    child: IconButton(
                      onPressed: () {
                        ...
                        if (p2 > 0 && p2 < int.parse(oldRSrno)) {
                          Pnoctrl.text = p2.toString().padLeft(4, '0');
                          getData(Pnoctrl.text);
                          setState(() {});
                        } else {
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: TextFormField(
                      controller: Pledgerbalancectrl,
                      focusNode: Plerdgerbalance,
                      keyboardType: TextInputType.text,
                      decoration: InputDecoration(
                        contentPadding: EdgeInsets.all(10),
                        enabledBorder: OutlineInputBorder(
